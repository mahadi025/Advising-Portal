    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='accounts.instructor')),
                ('time_slot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.timeslot')),
            ],
            options={
                'unique_together': {('semester', 'year', 'time_slot', 'course'), ('semester', 'year', 'time_slot', 'instructor'), ('course', 'sec_id', 'semester', 'year', 'time_slot'), ('classroom', 'semester', 'year', 'time_slot')},
            },
        ),
        migrations.AddField(
            model_name='course',
