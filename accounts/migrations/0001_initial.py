    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bloodGroup', models.CharField(blank=True, choices=[('A+', 'A+'), ('AB-', 'AB-'), ('B+', 'B+'), ('O-', 'O-'), ('O+', 'O+'), ('AB+', 'AB+'), ('A-', 'A-')], max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('semester', 'year', 'timeSlot', 'instructor'), ('semester', 'year', 'timeSlot', 'course'), ('secId', 'course', 'semester', 'year'), ('course', 'secId', 'semester', 'year', 'timeSlot'), ('classroom', 'semester', 'year', 'timeSlot')},
            },
        ),
        migrations.AddField(
            model_name='course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grade', models.CharField(blank=True, choices=[('B', 'B'), ('D+', 'D+'), ('C-', 'C-'), ('C', 'C'), ('A-', 'A-'), ('A+', 'A+'), ('C+', 'C+'), ('B+', 'B+'), ('D', 'D'), ('B-', 'B-'), ('F', 'F'), ('A', 'A')], max_length=2, null=True)),
