...
def calculate_gpa(username, semester, year):
    takes = takes = Takes.objects.filter(
        takes_id=username, section__semester=semester, section__year=year
    )
    Grade = {
        "A+": 4.00,
        "A": 4.00,
